namespace DBBase.Models
{
    ...
    public class OrderModels
    {
        ...
        public List<order> GetAllOrderByAdmin(DateTime from_date, DateTime to_date, string payment, int process, string search, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
                try
        ...
        public List<order> GetAllOrderByMember(string email, int page_index, int page_size, out int total)
        {
            using (var data = new Entities())
            {
                try
