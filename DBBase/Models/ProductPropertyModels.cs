namespace DBBase.Models
{
    ...
    public class ProductPropertyModels
    {
        ...
        public List<C_ProductProperty> AdminGetAllPropertyByProID(int pro_id, string type, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
                try
        ...
        public List<C_ProductProperty> GetPropertyByType(string type)
        {
            using (var data = new Entities())
            {
                try
                {
                    ...
                    List<C_ProductProperty> c_gen = new List<C_ProductProperty>();
