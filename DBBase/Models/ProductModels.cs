namespace DBBase.Models
{
    ...
    public class ProductModels
    {
        ...
        public List<C_Product> AdminGetAllProductByParentID(int parent, string type, string lang, string search, int page_index, int page_size, string order_by, string order_type, bool? is_show, bool? is_hot, bool? is_promotion, out int total, out int Total_store, out int Total_borrow, out int Total_in_stock)
        {
            using (var data = new Entities())
            {
                try
        ...
        /// <param name="total">The total.</param>
        /// <returns>PagedList C_Product</returns>
        public List<C_Product> AdminGetAllProductByParentIDALL(int parent, string type, string lang, string search, int page_index, int page_size, string order_by, string order_type, bool? is_show, bool? is_hot, bool? is_promotion, out int total, out int Total_store, out int Total_borrow, out int Total_in_stock)
        {
            using (var data = new Entities())
            {
                try
        ...
        /// <param name="total">The total.</param>
        /// <returns>PagedList C_Product</returns>
        public List<C_Product> GetListProductByCategoryID(string lang, string cate_type, int? cate_id, string search, string typekey, string manufacture, string tag, string param, int price_min, int price_max, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
