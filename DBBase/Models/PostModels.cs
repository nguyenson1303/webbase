namespace DBBase.Models
{
    ...
    public class PostModels
    {
        ...
        public List<C_Post> GetListPostAll(string lang, string cate_type, int? cate_id, string search, string tag, string param, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
                try
        ...
        /// <param name="total">The total.</param>
        /// <returns>Get List Post All</returns>
        public List<C_Post> GetListPostAll(string lang, string cate_type, int? cate_id, string search, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            try
            {
        ...
        public List<C_Post> TopPostHot(string type, string lang, int number)
        {
            using (var data = new Entities())
            {
                ...
                {
                    //// First, check the cache
                    List<C_Post> c_gen = new List<C_Post>();
