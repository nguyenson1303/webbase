namespace DBBase.Models
{
    ...
    public class RatingModels
    {
        ...
        public List<C_Rating> AdminGetAllRatingByProductId(int pro_id, string search, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
                try
