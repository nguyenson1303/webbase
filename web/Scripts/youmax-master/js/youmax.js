...
(function ($) {
	...
	loadYoumax = function() {	
		...
		//$('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="' + (youmaxWidgetWidth - 2) + '" height="' + (youmaxWidgetWidth / youmax_global_options.youtubeVideoAspectRatio) + '" src="" frameborder="0" allowfullscreen></iframe><ul class="mobile-columns-1 owl-carousel nav-center nav-style-7" data-loop="true" data-nav="true" data-dots="false" data-margin="30" data-responsive={"0":{"items":1,"nav":"false"},"480":{"items":2},"600":{"items":2},"1000":{"items":3}}><div id="youmax-video-list-div"></div></ul><div id="youmax-load-more-div">Load More</div></div>');
	...
	showUploads = function(response,playlistTitle,loadMoreFlag) {
		...
		for(var i=0; i<uploadsArray.length; i++) {
			...
			if((i+youmax_global_options.youmaxItemCount)%youmaxColumns!=0)
			    $('#youmax-video-list-div').append('<div class="youmax-video-tnail-box" style="width:' + ((100 / youmaxColumns) - 4) + '%;" no="' + (i + 1) + '_st" id="' + videoId + '"><div class="youmax-video-tnail" style="filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src=\'' + videoThumbnail + '\', sizingMethod=\'scale\'); background-image:url(\'' + videoThumbnail + '\');background-size: contain;"><div class="youmax-duration"></div></div><span class="youmax-video-list-title">' + videoTitle + '</span><br/><span class="youmax-video-list-views">' + getDateDiff(videoUploaded) + ' ago</span></div>');
			else
			    $('#youmax-video-list-div').append('<div class="youmax-video-tnail-box" style="width:' + ((100 / youmaxColumns) - 4) + '%; clear:both;" no="' + (i + 1) + '_st" id="' + videoId + '"><div class="youmax-video-tnail" style="filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src=\'' + videoThumbnail + '\', sizingMethod=\'scale\'); background-image:url(\'' + videoThumbnail + '\');background-size: contain;"><div class="youmax-duration"></div></div><span class="youmax-video-list-title">' + videoTitle + '</span><br/><span class="youmax-video-list-views">' + getDateDiff(videoUploaded) + ' ago</span></div>');
			
		}

		if (uploadsArray.length > 0) {
		    $('#youmax-video').attr('src', 'http://www.youtube.com/embed/' + uploadsArray[0].snippet.resourceId.videoId);
		    $('#youmax-video').show();
	...
	resetLoadMoreButton = function() {
		...
		$youmaxLoadMoreDiv.html('Xem th&ecirc;m')
	},
