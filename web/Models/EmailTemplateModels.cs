namespace Web.Models
{
    ...
    public class EmailTemplateModels
    {
        ...
        public PagedList<C_EmailTemplate> GetListEmailTemplateAll(int page_index, int page_site, out int total)
        {
            try
            {
                ...
                return lstEmailTempate.AsQueryable().ToPagedList(page_index, page_site);
            }
            catch (Exception)
            {
                total = 0;
