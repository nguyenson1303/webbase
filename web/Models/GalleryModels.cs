namespace Web.Models
{
    ...
    public class GalleryModels
    {
        ...
        public PagedList<ImageAlbum> AdminGetAllImageGallery(int parent, string type, string lang, int page_index, int page_size, string order_by, string order_type, out int total)
        {
            using (var data = new Entities())
            {
                try
